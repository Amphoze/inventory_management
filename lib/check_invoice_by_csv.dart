...
class CheckInvoiceByCsv extends StatefulWidget {
  const CheckInvoiceByCsv({super.key});

  @override
  State<CheckInvoiceByCsv> createState() => _CheckInvoiceByCsvState();
}

class _CheckInvoiceByCsvState extends State<CheckInvoiceByCsv> {
  ...
  Future<void> _checkInvoice() async {
    ...
    try {
      ...
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('${await Constants.getBaseUrl()}/orders/check-order-invoice'),
      );
