...
class _CrmDeveloperNotesDialogState extends State<CrmDeveloperNotesDialog> {
  ...
  void addDevelopmentNotes() {
    if (noteTitleController.text.isNotEmpty && noteTextController.text.isNotEmpty && notePriorityController.text.isNotEmpty) {
      setState(() {
        ...
        children: [
          ...
          ElevatedButton.icon(
            onPressed: () {
              ...
              List<String> versionParts = versionController.currentVersion.split('.');
              if (versionParts.length == 3) {
                ...
                // Update the version in the controller
