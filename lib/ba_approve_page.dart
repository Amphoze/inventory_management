                                ...
                                builder: (context, provider, child) {
                                  return PopupMenuButton<String>(
                                    ...
                                    onSelected: (String value) {
                                      ...
                                      if (value == 'All') {
                                        baApproveProvider.fetchOrdersWithStatus2(date: _selectedDate == 'Select Date' ? null : DateTime.parse(_selectedDate));
                                      } else {
                                        selectedCourier = value;
                                        baApproveProvider.fetchOrdersByMarketplace(value, 2, baApproveProvider.currentPage, date: _selectedDate == 'Select Date' ? null : DateTime.parse(_selectedDate));
                                      }
                                      log('Selected: $value');
                                    },
                    ...
                    if (baApproveProvider.isLoading)
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final percentDelhivery = double.parse(((order.freightCharge!.delhivery! / order.totalAmount!) * 100).toStringAsFixed(2));
                          final percentShiprocket = double.parse(((order.freightCharge!.shiprocket! / order.totalAmount!) * 100).toStringAsFixed(2));
                          ////////////////////////////////////////////////////////////////////////////
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                buildLabelValueRow(
                                                  ...
                                                  order.expectedDeliveryDate != null ? baApproveProvider.formatDate(order.expectedDeliveryDate!) : '',
                                                ),
                                                buildLabelValueRow('Preferred Courier', order.preferredCourier ?? ''),
                                                buildLabelValueRow(
                                                  'Payment Date Time',
                                                  order.paymentDateTime != null ? baApproveProvider.formatDateTime(order.paymentDateTime!) : '',
                                                ),
                                              ],
                                            ),
                                          ),
