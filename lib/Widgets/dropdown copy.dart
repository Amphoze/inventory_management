...
//   final url = Uri.parse('${await ApiUrls.getBaseUrl()}/category?name=$searchKey');
...
//   final prefs = await SharedPreferences.getInstance();
//   final token = prefs.getString('authToken') ?? '';
//   final url = Uri.parse('${await ApiUrls.getBaseUrl()}/boxsize?outerPackage_name=$query');
...
//   final prefs = await SharedPreferences.getInstance();
//   final token = prefs.getString('authToken') ?? '';
//   final url = Uri.parse('${await ApiUrls.getBaseUrl()}/products/fetch-products/$query');
