                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              ElevatedButton(
                                                onPressed: () {
                                                  Navigator.of(context).pop();
                                                  log('remark${remarkController.text}');
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (showBy(widget.order.checkInvoiceBy != null &&
                        widget.order.checkInvoiceBy!['approved']))
                      Text.rich(
                        TextSpan(
                            text: "Accounted By: ",
                            children: [
                              ...
                              if (widget.order.checkInvoiceBy!['timestamp'] !=
                                  null)
                                TextSpan(
                                    text:
                    ...
                    if (showBy(widget.order.checkedBy != null &&
                        widget.order.checkedBy!['approved']))
                      Text.rich(
                        TextSpan(
                            text: "Checked By: ",
                            children: [
                    ...
                    if (showBy(widget.order.rackedBy != null &&
                        widget.order.rackedBy!['approved']))
                      Text.rich(
                        TextSpan(
                            text: "Racked By: ",
                            children: [
                    ...
                    if (showBy(widget.order.manifestedBy != null &&
                        widget.order.manifestedBy!['approved']))
                      Text.rich(
                        TextSpan(
                            text: "Manifested By: ",
                            children: [
