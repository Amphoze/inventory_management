  ...
  Column _buildDetailsColumn() {
    return Column(
      ...
      children: [
        ...
        _buildInfoRow('Total Amount:', 'Rs.${item.amount}'),
  ...
  Column _buildFirstDetailsColumn() {
    return Column(
      ...
      children: [
        ...
        _buildInfoRow('Brand:', item.product?.brand),
  ...
  Column _buildSecondDetailsColumn() {
    return Column(
      ...
      children: [
        ...
        _buildInfoRow('Label:', item.product?.label),
        _buildInfoRow('Category:', item.product?.category),
      ],
    );
  }
      ...
      children: [
        ...
        _buildInfoRow(
            ...
            item.product?.grossWeight != null
                ...
                : 'N/A'),
        if (item.product?.boxSize != null && item.product!.boxSize!.isNotEmpty)
          _buildInfoRow('Box Size:', '${item.product!.boxSize}'),
        _buildInfoRow(
          'Variant Name:',
          item.product?.variantName != null
