...
class BookedOrderCard extends StatelessWidget {
  final Order order;
  final Widget? checkboxWidget;

  const BookedOrderCard({super.key, required this.order, this.checkboxWidget});
                      ...
                      Flexible(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            buildLabelValueRow(
                                'COD Amount', order.codAmount.toString() ?? ''),
                            buildLabelValueRow(
                      ...
                      Flexible(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            buildLabelValueRow(
                                'Calc Entry No.', order.calcEntryNumber ?? ''),
                            buildLabelValueRow(
