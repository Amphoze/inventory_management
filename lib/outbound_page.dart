...
class _OutboundPageState extends State<OutboundPage>
  ...
  void _reloadOrders() {
    ...
    final ordersProvider =
        Provider.of<OutboundProvider>(context, listen: false);
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: pro.isConfirm
                          ...
                          : () async {
                              final provider = Provider.of<OutboundProvider>(
                                  context,
                                  listen: false);
                              ...
                              if (selectedOrderIds.isEmpty) {
                                ...
                                String resultMessage = await provider
                                    .approveOrders(context, selectedOrderIds);
                        ...
                        children: [
                          Expanded(
                            child: TextField(
                                ...
                                prefixIcon: IconButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    if (searchTerm.isNotEmpty) {
                                      pro.searchReadyToConfirmOrders(
                                          searchTerm);
                                    }
                                  },
                                ),
                              ...
                              onSubmitted: (value) {
                                pro.searchReadyToConfirmOrders(value);
                              },
                              onChanged: (value) {
                                if (value.isEmpty) {
                                  pro.clearSearchResults();
                                          ...
                                          Flexible(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                buildLabelValueRow(
                                                  'Phone',
                                                  maskPhoneNumber(order.customer?.phone
                                                          ?.toString()) ??
                                                      '',
                                                ),
                                                buildLabelValueRow(
