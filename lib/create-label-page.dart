  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<LabelPageApi>(
        builder: (context, pro, child) => true
            ? ResponsiveLayout(
                child: Padding(
                  ...
                  child: ScrollConfiguration(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          _buildCardTextField(
                              labelPageProvider!.nameController, "Name"),
                          _buildCardTextField(
                              labelPageProvider!.labelSkuController,
                              "Label SKU"),
                          _buildCardTextField(
                              labelPageProvider!.imageController, "Image URL"),
                          _buildCardTextField(
                              labelPageProvider!.descriptionController,
                              "Description"),
                          ...
                          Row(
                            ...
                            children: [
                              _buildRoundedButton("Reset", Colors.grey, () {
                                labelPageProvider!
                                    .clearControllers(_dropdownKey);
                              }),
                              _buildRoundedButton(
                                  "Save", Colors.blueAccent, _saveLabel,
                                  loader: true),
                            ],
                          ),
                        ],
...
//               .entries
//               .map((entry) =>
//                   "${entry.key}:${entry.value['displayName'] as String? ?? 'null value'}")
//               .toList(),
