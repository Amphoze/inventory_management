...
//           .add(TextEditingController(text: item['qty'].toString()));
//       _addedProductAmountControllers
...
//         double amount =
//             double.tryParse(_addedProductAmountControllers[index].text) ?? 0.0;
//         int qty =
...
//         var item = entry.value;
//         double amount =
//             double.tryParse(_addedComboAmountControllers[index].text) ?? 0.0;
...
//                   double.parse(_productAmountControllers[index].text))
//               .toString();
...
//                   .toString();
//           _totalAmtController.text = (double.parse(_totalAmtController.text) -
//                   double.parse(_addedProductAmountControllers[index].text))
//               .toString();
...
//                   .toString();
//           _totalAmtController.text = (double.parse(_totalAmtController.text) -
//                   double.parse(_addedComboAmountControllers[index].text))
//               .toString();
...
//                   .toString();
//           _totalAmtController.text = (double.parse(_totalAmtController.text) -
//                   double.parse(_comboAmountControllers[index].text))
//               .toString();
...
//                         final product = remainingItems![index];
//                         final id = product.id;
//                         log('id: $id');
...
//                                       controller:
//                                           _productAmountControllers[index],
//                                       label: 'Amount',
//                                       icon: Icons.currency_rupee,
//                                     ),
//                                   ),
...
//                   totalController.text = newTotal.toString();
//                 }
//               });
//             },
//           );
