...
import 'package:inventory_management/create_orders.dart';
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          DropdownButtonFormField<String>(
                                            ...
                                            items: statuses.map<DropdownMenuItem<String>>((Map<String, String> status) {
                                          ...
                                          Consumer<MarketplaceProvider>(
                                              builder: (context, provider, child) => DropdownButtonFormField<String>(
                                                    ...
                                                    onChanged: (String? newValue) {
                                                      if (newValue != null) {
                                                        setState(() {
                                                          _marketplace = newValue;
                                                        });
                                                      }
                                                    },
                                                    items: [
                                                      ...provider.marketplaces.map((marketplace) => DropdownMenuItem<String>(
                                                            value: marketplace.name.toString(),
                                                            child: Text(marketplace.name.toString()),
                                                          )),
                                                  ...
                                                  try {
                                                    ...
                                                    setState(() {
                                                      if (_selectedStatus != 'all') {
                                                        _selectedStatus = statuses.firstWhere((map) => map.containsKey(_selectedStatus), orElse: () => {})[_selectedStatus]!;
                                                      }
                                                    });
