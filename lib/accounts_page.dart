...
class _AccountsPageState extends State<AccountsPage> {
  ...
  void _onSearchChanged(String value) {
    ...
    _debounce = Timer(const Duration(milliseconds: 300), () {
      accountsProvider.searchOrders(value);
    });
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                          ...
                          : () async {
                              ...
                              if (selectedOrderIds.isEmpty) {
                                ...
                                Utils.showSnackBar(context, resultMessage,
                                    color: snackBarColor, toRemoveCurr: true, seconds: 5);
                              }
                            },
          ...
          _buildTableHeader(accountsProvider.orders.length),
          const SizedBox(height: 4),
          Consumer<AccountsProvider>(builder: (context, accountsProvider, child) {
            return Expanded(
              child: Stack(
                children: [
                  if (accountsProvider.isLoading)
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        List<Message> confirmerMessages =
                            order.messages == null ? [] : order.messages!.confirmerMessages;
                        List<Message> accountMessages = order.messages == null ? [] : order.messages!.accountMessages;

                        return Card(
                          surfaceTintColor: Colors.white,
                          color: accountsProvider.selectedAccounts[index] ? Colors.grey[300] : Colors.grey[100],
                          elevation: 2,
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Checkbox(
                                      value: accountsProvider.selectedAccounts[index],
                                      onChanged: (isSelected) {
                                        accountsProvider.toggleOrderSelectionAccounts(index, isSelected!);
                                      },
                                    ),
                                    Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                          ...
                                          onPressed: () async {
                                            ...
                                            if (result == true) {
                                              ...
                                              if (searched.isNotEmpty) {
                                                accountsProvider.searchOrders(searched);
                                              } else {
                                                accountsProvider.fetchOrdersWithStatus2();
                                              }
                                            }
                                            ...
                                            if (order.confirmedBy!['status'] == true)
                                              Text.rich(
                                                TextSpan(
                                                    ...
                                                    children: [
                                                      TextSpan(
                                                          text: order.confirmedBy!['confirmedBy']
                                                              .toString()
                                                              .split('@')[0],
                                                          style: const TextStyle(
                                                            fontWeight: FontWeight.normal,
                                                ...
                                                showWriteRemarkDialog(
                                                  ...
                                                  onSubmitted: () async {
                                                    ...
                                                    if (searched.isEmpty) {
                                                      ...
                                                      await accountsProvider.searchOrders(searched);
                                                    }
                                                  },
                                                );
                                              },
                                              child:
                                                  Text(accountMessages.isNotEmpty ? 'Add a Remark' : 'Write a Remark'),
                                            ),
          ...
          Consumer<AccountsProvider>(
            builder: (context, accountsProvider, child) {
              return CustomPaginationFooter(
                ...
                buttonSize: 30,
                totalCount: accountsProvider.totalOrdersAccounts,
  ...
  Widget _buildTableHeader(int totalCount) {
    return Consumer<AccountsProvider>(builder: (context, pro, child) {
      return Container(
        ...
        child: Row(
          children: [
            Transform.scale(
              scale: 0.8,
              child: Checkbox(
                value: pro.allSelectedAccounts,
                onChanged: (value) {
                  pro.toggleSelectAllAccounts(value ?? false);
                },
              ),
            ),
            Text(
              'Select All (${pro.selectedAccountOrderCount})',
            ),
            buildHeader('ORDERS')
          ],
        ),
