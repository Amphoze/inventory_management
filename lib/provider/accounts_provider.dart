...
class AccountsProvider with ChangeNotifier {
  ...
  Future<void> fetchOrdersWithStatus2() async {
    ...
    const url =
        'https://inventory-management-backend-s37u.onrender.com/orders?orderStatus=2&page=';
  ...
  Future<List<Order>> searchOrders(String query) async {
    ...
    final url =
        'https://inventory-management-backend-s37u.onrender.com/orders?orderStatus=2&order_id=$query';
