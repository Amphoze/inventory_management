...
class RackedProvider with ChangeNotifier {
  ...
  Future<String> cancelOrders(BuildContext context, List<String> orderIds) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await fetchOrdersWithStatus7(); // Assuming fetchOrders is a function that reloads the orders
  ...
  Future<void> fetchOrdersWithStatus7() async {
    ...
    String url = '${await Constants.getBaseUrl()}/orders?warehouse=$warehouseId&orderStatus=7&page=';
...
// Method to search orders by order ID
  Future<List<Order>> searchOrders(String query) async {
    ...
    final url = '${await Constants.getBaseUrl()}/orders?warehouse=$warehouseId&orderStatus=7&order_id=$query';
