        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: [
                ...statuses.map<DropdownMenuItem<String>>((Map<String, String> status) {
                ...
                onPressed: () async {
                  if (_canGenerate && !_isDownloading) {
                    ...
                    try {
                      ...
                      String marketplacesParam = selectedMarketplaces.isEmpty ? 'marketplace=' : 'marketplace=${selectedMarketplaces.join(',')}';

                      String url = '$baseUrl/orders/download?startDate=$startDate&endDate=$endDate&order_status=$_selectedStatus&$marketplacesParam';
